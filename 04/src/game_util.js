...
class util {
    ...
    createSpriteMaterial(texture) {
        ...
        var param = { map: texture, color: 0xFFFFFF, transparent: true, side:THREE.DoubleSide };
        return new THREE.SpriteMaterial(param);
    }

    //テクスチャを反転
    filpx(material,dirc) {
        material.map.repeat.x = (0<dirc)? -1 : + 1;
    }
...
class WorldBase {
    ...
    initScene() {
        ...
        renderer.setSize(screen_width, screen_height, true);
